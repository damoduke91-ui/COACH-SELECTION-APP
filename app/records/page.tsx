      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <section className="rounded-2xl border border-dashed border-white/10 bg-white/5 p-8">
          ...
          <p className="mt-3 text-sm leading-6 text-white/70">
            This page will eventually hold season records, historical records, and other notable
            competition achievements.
          </p>

          <div className="mt-6 rounded-xl border border-white/10 bg-black/20 p-4 text-sm text-white/60">
            Planned future content:
            <div className="mt-2">- highest weekly scores</div>
            <div>- biggest wins</div>
            <div>- season records</div>
            <div>- previous season records later on</div>
          </div>
        </section>
      </div>
    </main>
