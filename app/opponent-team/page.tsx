      ...
      <div className="mx-auto max-w-4xl space-y-6">
        <section className="rounded-2xl border border-white/10 bg-white/5 p-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-3xl font-bold">See Opponent&apos;s Team</h1>
        ...
        <section className="rounded-2xl border border-dashed border-white/10 bg-white/5 p-8">
          ...
          <p className="mt-3 text-sm leading-6 text-white/70">
            This page will eventually show each coach their opponent&apos;s team once that flow is
            built. For now, the page is live so your dashboard navigation works properly.
          </p>

          <div className="mt-6 rounded-xl border border-white/10 bg-black/20 p-4 text-sm text-white/60">
            Planned future content:
            <div className="mt-2">- opponent team list</div>
            <div>- position-by-position view</div>
            <div>- submitted / locked status</div>
            <div>- matchup comparison against your own team</div>
          </div>
        </section>
      </div>
    </main>
